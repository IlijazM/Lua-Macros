...
public class KeyboardEvent extends AbstractSwingInputAdapter implements NativeKeyListener, NativeMouseMotionListener {
	...
	static void init() {
		...
		try {
			...
			GlobalScreen.addNativeMouseMotionListener(new KeyboardEvent());
